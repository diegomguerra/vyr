...
const products = {
  dia: {
    ...
    contains: ["Bacopa Monnieri", "L-Teanina", "Citicolina", "Rhodiola Rosea", "Vitamina B12"],
    doesNotContain: ["Açúcar", "Glúten", "Lactose"],
    usage: {
      instruction: "Diluir 1 sachê (5g) em 200ml de água.",
    ...
    ingredientsList: "Bacopa Monnieri (extrato padronizado 50% bacosides), L-Teanina, Citicolina (CDP-Colina), Rhodiola Rosea (extrato padronizado 3% rosavins), Cianocobalamina (Vitamina B12), aroma natural de frutas vermelhas, acidulante ácido cítrico, regulador de acidez citrato de sódio. NÃO CONTÉM GLÚTEN. CONTÉM AROMATIZANTE. CONTÉM CORANTE NATURAL.",
    allergens: "ALÉRGICOS: PODE CONTER SOJA.",
    nutritionTable: [
      { nutrient: "Bacopa Monnieri", amount: "300 mg", vd: "*" },
      { nutrient: "L-Teanina", amount: "200 mg", vd: "*" },
      { nutrient: "Citicolina", amount: "250 mg", vd: "*" },
      { nutrient: "Rhodiola Rosea", amount: "150 mg", vd: "*" },
      { nutrient: "Vitamina B12", amount: "1000 mcg", vd: "4166%" },
    ],
    price: "R$ 147",
    priceOld: "R$ 197",
  },
  tarde: {
    ...
    contains: ["Lion's Mane", "Ashwagandha KSM-66", "Alpha-GPC", "Magnésio Treonato", "Vitamina D3"],
    doesNotContain: ["Açúcar", "Glúten", "Lactose"],
    usage: {
      instruction: "Diluir 1 sachê (5g) em 200ml de água.",
    ...
    ingredientsList: "Lion's Mane (Hericium erinaceus extrato 30% polissacarídeos), Ashwagandha KSM-66 (extrato padronizado 5% withanolides), Alpha-GPC (L-alfa-glicerilfosforilcolina), Magnésio L-Treonato, Colecalciferol (Vitamina D3), aroma natural, acidulante ácido cítrico, regulador de acidez citrato de sódio. NÃO CONTÉM GLÚTEN. CONTÉM AROMATIZANTE. CONTÉM CORANTE NATURAL.",
    allergens: "ALÉRGICOS: PODE CONTER SOJA.",
    nutritionTable: [
      { nutrient: "Lion's Mane", amount: "500 mg", vd: "*" },
      { nutrient: "Ashwagandha KSM-66", amount: "300 mg", vd: "*" },
      { nutrient: "Alpha-GPC", amount: "200 mg", vd: "*" },
      { nutrient: "Magnésio Treonato", amount: "144 mg", vd: "34%" },
      { nutrient: "Vitamina D3", amount: "2000 UI", vd: "400%" },
    ],
    price: "R$ 147",
    priceOld: "R$ 197",
  },
  noite: {
    ...
    contains: ["Glicina", "L-Triptofano", "Fosfatidilserina", "Zinco", "Melatonina"],
    doesNotContain: ["Açúcar", "Glúten", "Lactose"],
    usage: {
      instruction: "Diluir 1 sachê (5g) em 200ml de água.",
    ...
    ingredientsList: "Glicina, L-Triptofano, Fosfatidilserina (20% concentração), Zinco bisglicinato, Melatonina, aroma natural de camomila com mel, acidulante ácido cítrico, regulador de acidez citrato de sódio. NÃO CONTÉM GLÚTEN. CONTÉM AROMATIZANTE. CONTÉM CORANTE NATURAL.",
    allergens: "ALÉRGICOS: PODE CONTER SOJA.",
    nutritionTable: [
      { nutrient: "Glicina", amount: "3000 mg", vd: "*" },
      { nutrient: "L-Triptofano", amount: "500 mg", vd: "*" },
      { nutrient: "Fosfatidilserina", amount: "100 mg", vd: "*" },
      { nutrient: "Zinco", amount: "15 mg", vd: "136%" },
      { nutrient: "Melatonina", amount: "0.5 mg", vd: "*" },
    ],
    price: "R$ 147",
    priceOld: "R$ 197",
  },
