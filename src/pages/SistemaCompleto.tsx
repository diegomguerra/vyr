            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800/50 border border-slate-700/50">
                  ...
                  <span className="text-sm text-slate-300">Smart Ring Incluso</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800/50 border border-slate-700/50">
                  <Brain className="w-4 h-4 text-violet-400" />
                  <span className="text-sm text-slate-300">Insights AI</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800/50 border border-slate-700/50">
                  <BarChart3 className="w-4 h-4 text-cyan-400" />
                  <span className="text-sm text-slate-300">Correlações</span>
                </div>
              </div>

              {/* Pricing */}
              <div className="bg-slate-900/80 rounded-2xl p-6 border border-fuchsia-500/20 backdrop-blur-sm">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-sm text-slate-500 line-through">R$ 6.561</span>
                  <span className="text-sm font-semibold text-emerald-400 bg-emerald-500/10 px-2 py-1 rounded-full">
                    -40% OFF
                  </span>
                </div>
                <div className="flex items-baseline gap-3 mb-4">
                  <span className="text-4xl font-bold text-white">R$ 3.937</span>
                  <span className="text-slate-400">ou 12x de R$ 328</span>
                </div>

                <Link to="/login?signup=true">
                  <Button className="w-full py-6 text-lg font-semibold bg-gradient-to-r from-fuchsia-600 via-violet-600 to-indigo-600 hover:from-fuchsia-700 hover:via-violet-700 hover:to-indigo-700 text-white shadow-lg shadow-fuchsia-500/25 rounded-xl transition-all duration-300 hover:scale-[1.02]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {ringFeatures.map((feature, idx) => (
              <div
                key={idx}
                className="p-6 rounded-2xl bg-slate-900/50 border border-slate-700/50 hover:border-fuchsia-500/30 transition-colors"
              >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      {feature.exclusive && (
                        <span className="px-2 py-0.5 text-xs font-semibold bg-fuchsia-500/20 text-fuchsia-400 rounded-full">
                          Exclusivo
                        </span>
                      )}
                    </div>
